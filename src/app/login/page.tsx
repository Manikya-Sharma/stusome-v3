    ...
    <div className="relative min-h-screen w-full bg-blue-50">
      {session?.user?.email && session.user.id ? (
        ...
        <>
          ...
          <main className="absolute mt-7 top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-[90vw] md:w-[70vw] h-[85vh] bg-white rounded-sm flex">
            <div className="pt-20 px-10 flex-1">
              ...
              <p className="mt-2 text-muted-foreground text-sm tracking-wide">
                ...
                <span className="text-blue-500">better</span> social media
              </p>
              <div className="mt-14">
                <LoginTiles />
              </div>
            ...
            <div className="hidden md:block flex-[1.5]">
              ...
              <div className="w-full h-full bg-slate-300 rounded-tl-[7rem] rounded-sm" />
            </div>
          </main>
        </>
      )}
